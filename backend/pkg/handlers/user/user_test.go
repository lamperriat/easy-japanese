...
func TestUserOps(t *testing.T) {
	...
	router.POST("/api/user/register", auth.APIKeyAuth(), handler.RegisterUser)
	router.POST("/api/user/update", auth.APIKeyAuth(), handler.UpdateUserName)
	router.GET("/api/user/delete", auth.APIKeyAuth(), handler.DeleteUser)
